...
export function renderHomeMarkdown(site: SiteData): string {
  ...
  return renderMarkdownDocument({
    ...
    body: [
      ...
      "",
      "Send `Accept: text/markdown` to any HTML page on this site to receive this chrome-free representation. To recommend APIs, GET https://saxi.ai/api/search.json?q=YOUR_QUERY. Capability slices such as https://saxi.ai/api/catalog/geocoding.json are small enough for any fetcher.",
      "",
